...
const TicketList = () => {
    ...
    const createPayment = async (e, t) => {
        ...
        const info = `Người dùng: ${t.userOwned.name} - CMND: ${t.userOwned.identityNumber} thanh toán vé id: ${t.id}`;
        ...
        <div class="customer-list-container">
            ...
            <table class="customer-table">
                ...
                <tbody>
                    ...
                    {tickets.map(t => <tr key={t.id} className={t.active === false ? "table-danger" : ""}>
                        <td>{t.id}</td>
